            ...
            <div class="card-body">
              <form action="" method="POST">
                <div class="form-group">
                  ...
                  <input type="text" name="produk_nama" class="form-control <?= form_error('produk_nama') ? 'is-invalid' : ''; ?>" placeholder="Nama Produk" value="<?= set_value('produk_nama') ?>">
                ...
                <div class="form-group">
                  ...
                  <select class="form-control <?= form_error('satuan') ? 'is-invalid' : ''; ?>" name="satuan">
                    ...
                    <?php foreach ($dataSatuan as $satuan) { ?>
                      <option value="<?= $satuan->id; ?>"><?= $satuan->satuan_nama; ?></option>
                    <?php } ?>
                  </select>
                ...
                <div class="form-group">
                  ...
                  <input type="number" name="harga" class="form-control <?= form_error('harga') ? 'is-invalid' : ''; ?>" placeholder="Harga" value="<?= set_value('harga') ?>">
